"""Run fixed-operand LayerNorm subtraction attribution from a public SHA."""
...
COMMIT_SHA = "a5b7690fd0e3b24a98e26fe2c134b93308107762"
REPOSITORY = "https://github.com/TryDotAtwo/TPUBeamSearch.git"
CHECKOUT = Path("/tmp/TPUBeamSearch-artgor-layernorm-subtraction")
OUTPUT = Path("/kaggle/working/artgor_layernorm_subtraction")
...
def main() -> None:
    ...
    command = (
        sys.executable, "-m", "benchmarks.artgor_layernorm_subtraction",
        "--output", str(OUTPUT),
    )
    with (OUTPUT / "subtraction.log").open("w", encoding="utf-8") as log:
