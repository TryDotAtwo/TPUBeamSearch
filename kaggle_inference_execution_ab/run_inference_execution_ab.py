"""Private eight-TPU execution A/B fetched from one public Git SHA."""
...
COMMIT_SHA = "88d6e42c4100578aa9478d3faf6b4f5d30adc01f"
REPOSITORY = "https://github.com/TryDotAtwo/TPUBeamSearch.git"
CHECKOUT = Path("/tmp/TPUBeamSearch")
OUTPUT = Path("/kaggle/working/inference_execution_ab")
...
def main():
    ...
    command = (
        sys.executable, "-m", "benchmarks.stream1_inference_execution_ab",
        "--output", str(OUTPUT),
    )
