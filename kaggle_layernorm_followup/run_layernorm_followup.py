"""Private follow-up bundle; source is fetched from one published Git SHA."""
...
COMMIT_SHA = "d58cf9fd8e86ec145c6bbc4f6c7f5aff489d6e21"
REPOSITORY = "https://github.com/TryDotAtwo/TPUBeamSearch.git"
CHECKOUT = Path("/tmp/TPUBeamSearch")
OUTPUT = Path("/kaggle/working/arithmetic_followup")
...
def main():
    ...
    command = (sys.executable, "-m", "benchmarks.stream1_layernorm_followup", "--output", str(OUTPUT))
