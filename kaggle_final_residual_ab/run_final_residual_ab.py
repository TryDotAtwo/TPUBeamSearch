"""Private eight-TPU final-residual A/B fetched from one public Git SHA."""
...
COMMIT_SHA = "267df37cd3a35b19ad6250d43768bfd5b536b67c"
REPOSITORY = "https://github.com/TryDotAtwo/TPUBeamSearch.git"
CHECKOUT = Path("/tmp/TPUBeamSearch")
OUTPUT = Path("/kaggle/working/final_residual_ab")
...
def main():
    ...
    command = (
        sys.executable, "-m", "benchmarks.stream1_final_residual_ab",
        "--output", str(OUTPUT),
    )
