"""Run the Artgor LayerNorm attribution bundle from one public Git SHA."""
...
COMMIT_SHA = "fee05807dc82a836bf3c8c17aba03131033b86c9"
...
def main() -> None:
    ...
    command = (
        sys.executable,
        "-m",
        "benchmarks.artgor_layernorm_attribution",
        "--output",
        str(OUTPUT),
    )
    with (OUTPUT / "attribution.log").open("w", encoding="utf-8") as log:
